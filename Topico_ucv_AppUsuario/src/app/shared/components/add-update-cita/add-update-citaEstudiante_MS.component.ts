...
@Component({
  ...
  templateUrl: './add-update-citaEstudiante_MS.component.html',
  styleUrls: ['./add-update-citaEstudiante_MS.component.scss'],
})
export class AddUpdateCitaEstudianteMSComponent implements OnInit {
  @Input() cita: Cita;
...
this.doctorSeleccionado = this.doctorService.getDoctorSeleccionado('psicologia') || '';
